...
public class PaimonSourceConfig {
  public static final String PARTITION_SPEC_EXTRACTOR_CLASS =
      "xtable.paimon.source.partition_spec_extractor_class";
  public static final String PARTITION_FIELD_SPEC_CONFIG =
      "xtable.paimon.source.partition_field_spec_config";

  String partitionSpecExtractorClass;
  List<PartitionFieldSpec> partitionFieldSpecs;

  public static PaimonSourceConfig fromPartitionFieldSpecConfig(String partitionFieldSpecConfig) {
    return new PaimonSourceConfig(
  ...
  public static PaimonSourceConfig fromProperties(Properties properties) {
    ...
    return new PaimonSourceConfig(partitionSpecExtractorClass, partitionFieldSpecs);
  }
  ...
  public PaimonSourcePartitionSpecExtractor loadSourcePartitionSpecExtractor() {
    Preconditions.checkNotNull(
        partitionSpecExtractorClass, "PaimonSourcePartitionSpecExtractor class not provided");
