 ...
 */
@AllArgsConstructor
public class ConfigurationBasedPartitionSpecExtractor implements PaimonSourcePartitionSpecExtractor {
  private final PaimonSourceConfig config;
  ...
  public List<InternalPartitionField> spec(InternalSchema tableSchema) {
    ...
    for (PaimonSourceConfig.PartitionFieldSpec fieldSpec : config.getPartitionFieldSpecs()) {
